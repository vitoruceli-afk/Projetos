...
#   DEPLOY_DB_PASS='sua_senha_aqui' ./deploy_conta_telefonia.sh /caminho/para/controle
#
# IMPORTANTE
...
if [ -z "${DEPLOY_DB_PASS:-}" ]; then
    ...
    echo "Exemplo: DEPLOY_DB_PASS='sua_senha' $0 /caminho/para/controle" >&2
    exit 1
fi
DB_PASS="$DEPLOY_DB_PASS"

if [ "$#" -lt 1 ]; then
    echo "Uso: DEPLOY_DB_PASS='sua_senha' $0 /caminho/para/controle" >&2
    exit 1
fi
