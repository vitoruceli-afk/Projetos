...
return [
    ...
    */
    'app' => [
        ...
        // ou "/controle" caso esteja em uma subpasta.
        'base_url'  => '',
    ...
    */
    'ldap' => [
        ...
        'grupo_admin'  => 'CN=Controle-Admins,OU=Grupos,DC=empresa,DC=local',
        'grupo_usuario'=> 'CN=Controle-Usuarios,OU=Grupos,DC=empresa,DC=local',
