...
$allowed_pages = ['dashboard', 'routers', 'hotspot', 'firewall', 'diagnostics', 'users', 'logs', 'bypass', 'actions', 'schedules'];
...
$pages_that_require_router = ['hotspot', 'firewall', 'diagnostics', 'bypass', 'actions', 'schedules'];
