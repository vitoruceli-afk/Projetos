...
class FormBuilderAdvanced {
        ...
        const modal = `
            <div id="sectionModal" class="builder-modal" style="display: block; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000;">
                <div class="modal-content" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 2rem; border-radius: 8px; width: 90%; max-width: 600px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <div class="form-group" style="background: #f0f9ff; padding: 1rem; border-radius: 4px; border-left: 4px solid #3498db;">
                        <label style="display: flex; align-items: center; gap: 0.75rem; font-weight: normal; margin: 0;">
                            <input type="checkbox" id="sectionShowTitle" checked style="width: 18px; height: 18px; cursor: pointer;">
                            <span>👁️ Mostrar título da seção no preenchimento</span>
                        </label>
                        <p style="margin: 0.5rem 0 0 1.75rem; font-size: 0.85rem; color: #0c5460;">
                            Desmarque para esconder o título quando usuários preencherem o formulário
                        </p>
                    </div>
        ...
        const modal = `
            <div id="editSectionModal" class="builder-modal" style="display: block; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000;">
                <div class="modal-content" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 2rem; border-radius: 8px; width: 90%; max-width: 600px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <div class="form-group" style="background: #f0f9ff; padding: 1rem; border-radius: 4px; border-left: 4px solid #3498db;">
                        <label style="display: flex; align-items: center; gap: 0.75rem; font-weight: normal; margin: 0;">
                            <input type="checkbox" id="editSectionShowTitle" ${section.show_title == 1 ? 'checked' : ''} style="width: 18px; height: 18px; cursor: pointer;">
                            <span>👁️ Mostrar título da seção no preenchimento</span>
                        </label>
                        <p style="margin: 0.5rem 0 0 1.75rem; font-size: 0.85rem; color: #0c5460;">
                            Desmarque para esconder o título quando usuários preencherem o formulário
    ...
    saveSection() {
        ...
        const showTitle = document.getElementById('sectionShowTitle').checked;
    ...
    updateSection(sectionId) {
        ...
        const showTitle = document.getElementById('editSectionShowTitle').checked;
                    ...
                    <div class="section-item" draggable="true" data-section-id="${section.id}" style="background: #f8f9fa; padding: 1.5rem; border-radius: 8px; margin-bottom: 1.5rem; border: 2px solid #3498db; cursor: move;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                            <div style="flex: 1;">
                                ...
                                <p style="margin: 0.5rem 0 0 0; font-size: 0.85rem; color: #3498db;"><strong>📊 ${section.columns} coluna${section.columns > 1 ? 's' : ''}</strong> ${section.show_title ? '👁️ Título visível' : '👁️‍🗨️ Título oculto'}</p>
                            </div>
